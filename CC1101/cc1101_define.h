...
#define CC1100_RCCTRL1_STATUS     0x3C
#define CC1100_RCCTRL0_STATUS     0x3D
...
#define CC1100_PKTSTATUS_CCA_BM				   (BIT4)
#define CC1100_PKTSTATUS_CS_BM				   (BIT6)
